...
type Honour = { key: string; title: string; detail: string; photo: string };
type CvData = {
  profile: Profile;
    ...
    <div style={{ maxWidth: 720, margin: "0 auto", padding: "32px 20px 120px", fontFamily: "'Inter', sans-serif" }}>
        ...
        <button
          ...
          onClick={() =>
            setData({
              ...
              pressItems: [
                ...data.pressItems,
                { key: newKey(), publication: "", headline: "", year: "", photo: "", logo: "" },
              ],
            })
          }
        >
      ...
      <section style={{ marginBottom: 32 }}>
        ...
        <button
          style={buttonStyle}
          onClick={() =>
            setData({ ...data, honours: [...data.honours, { key: newKey(), title: "", detail: "", photo: "" }] })
          }
        >
          + Add honour
        </button>
